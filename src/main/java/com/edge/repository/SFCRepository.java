...
public class SFCRepository extends AbstractJsonRepository<SFC>
{
    ...
    static class SFCNotFoundException extends EntityNotFoundException
    {

        public SFCNotFoundException(String message)
        {
    ...
    static class SFCAlreadyExistsException extends EntityAlreadyExistsException
    {

        public SFCAlreadyExistsException(String message)
        {
