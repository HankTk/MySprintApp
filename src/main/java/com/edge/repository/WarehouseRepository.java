...
public class WarehouseRepository extends AbstractJsonRepository<Warehouse>
{
    ...
    static class WarehouseNotFoundException extends EntityNotFoundException
    {
    ...
    static class WarehouseAlreadyExistsException extends EntityAlreadyExistsException
    {
